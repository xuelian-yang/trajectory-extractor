...
CASE_NAME="alaco_W92_2023-05-09_14_18_54"
SOURCE_FOLDER="test_alaco"/${CASE_NAME}
VIDEO_NAME="W92_2023-05-09_14_18_54.mp4"
NAME="W92_2023-05-09_14_18_54"
GIF_NAME="alaco_traj_demo_"${CASE_NAME}_${var_video_name}".gif"
DELTA_MS=100
...
# 标定文件
CAMERA_STREET="10.10.145.232_cfg.yml"
...
DET_ZONE_IM_VEHICLES="10.10.145.232_detection_zone_im.yml"
DET_ZONE_FNED_VEHICLES="10.10.145.232_detection_zone.yml"
IGNORE_AREA_VEHICLES=""

DET_ZONE_IM_PEDESTRIANS="10.10.145.232_detection_zone_im.yml"
DET_ZONE_FNED_PEDESTRIANS="10.10.145.232_detection_zone.yml"
# TODO: 生成行人忽略区域
...
text_warn "run_alaco.sh elapsed:  $time_diff_sh   seconds. ($time_sh_end - $time_sh_start)"
